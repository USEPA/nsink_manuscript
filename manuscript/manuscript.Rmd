...
```
```{r show_summary, include = TRUE}
kable(niantic_fp_removal, caption = "Summary table of N removal along specified flowpath")
```
## Static maps
...
```{r plots, fig.cap = "Nitrogen Removal Efficiency (NRE, range 0 to 100%) is the estimeated percentage of N removed within three types of landscape N sinks - wetlands, streams, ponds."}
...
Use Examples
============
N-Sink is now available for HUC-12 catchments in coastal CT, RI and southern MA and decision-makers are beginning to make use of maps and data available as an [interactive tool](https://uconnclear.maps.arcgis.com/apps/MapSeries/index.html?appid=e96b01502f5b4aeda64aacf0cb5234c7&folderid=dde199a7cf674845a83b43a3011b1d31).
However, we are aware of various ways this tool is starting to be integrated into risk analyses. Here we demonstrate two examples using the Niantic River (CT) the Farm River (CT) HUCs. 
