...
author:
- Kellogg, D. Q. ^*1*^, Hollister. J. W. ^\*^ ^*2*^, Arnold, C. L.^*3*^, Gold, A. J. ^*1*^,
...
abstract: "Excess nitrogen (N) loading to coastal ecosystems impairs estuarine water
  ...
  impact on downstream N delivery. Natural features frequently found within the 
  headwaters of watersheds can act as landscape sinks for N, such as wetlands, streams 
  and ponds that transform dissolved N into gaseous N, effectively removing it from 
  the aquatic system. Identifying and evaluating these landscape sinks and their spatial
  relationship to N sources can help managers understand the effects of alternative 
  decisions on downstream resources. N-Sink is an approach that uses widely available 
  GIS data to identify landscape sinks within
